<template>
    <div class="aboutus-secktion">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h1 class="lg-text font-weight-bold"">Qui sommes nous ?</h1>
                        <p class="image-aboutus-para">Nous sélectionnons inlassablement pour vous les meilleurs producteurs</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="text-justify">Depuis 1973, l’entreprise familiale travaille dans l’exigence renouvelée du détail qui fait l’art
                        ...
                        rechercher des vins hors des sentiers battus.</p>
                </div>
            </div>
        </div>
        <div class="container">
        ...
        <div class="container text-center paddingTB60">
        <a href="../"><button class="btn btn-primary btn-history btn-outline-danger">RETOURNER À L'ACCUEIL</button></a>   
        </div>
    </div>
</template>