<template>
  <div class="container text-justify" id="cgv-container">
    <h2>Conditions générales de vente</h2>
    <h5>1. Droit de révocation et réclamations au sujet de la marchandise</h5>
    <p>La commande, quel que soit le moyen de paiement choisi, est ferme et définitive. L’acheteur ne dispose d’aucun droit de rétractation ou de révocation de sa commande et ne peut donc restituer la marchandise commandée. Pour le surplus, toute réclamation concernant la marchandise doit être faite par écrit auprès de Elie Gazzar SA dans les 8 jours dès la livraison.</p>
    <br>
    <h5>2. Goût de bouchon</h5>
    <p>Elie Gazzar S.A. calcule les prix de vente de ses vins au plus juste. Ceux-ci n'incluent pas de marge pour les bouteilles présentant un éventuel goût de bouchon. Aussi, un cas isolé de goût de bouchon ne peut donner droit à aucune prétention de la part du client.</p>
    <br>
    <h5>3. Interdiction de vente à des mineurs</h5>
    <p>Par son acceptation des conditions générales, le client certifie qu’il est âgé d’au moins 18 ans. En effet, est prohibée expressément par la loi la vente de spiritueux, d’apéritifs et d’alcopops aux personnes de moins de 18 ans, ainsi que la vente de vins, cidres et bières aux moins de 16 ans.</p>
    <br>
    <h5>4. Cas spécial des vins vendus en primeurs</h5>
    <p>
    ...
    <br>
    <h5>5. Moment du paiement</h5>
    <p>Elie Gazzar SA exige systématiquement de ses nouveaux clients le paiement par avance, c’est-à-dire avant la livraison. Dans les autres cas, sauf convention contraire entre les parties, le délai de paiement est de trente jours net dès la commande.</p>
    <br>
    <h5>6. Participation aux frais de livraison</h5>
    <p>
    ...
    <br>
    <h5>7. Dispositions en matière de protection des données</h5>
    <p>
